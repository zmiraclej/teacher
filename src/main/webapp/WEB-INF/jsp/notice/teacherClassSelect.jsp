...
$(function() {
	...
	$.ajax({
	    url: "../teacherNotice/searchClassSelectStatus",
	    type: "GET",
...
$('input:checkbox').click(function () { 
	...
	$.ajax({
	    url: "../teacherNotice/saveTeacherClassSelect",
	    type: "POST",
	    contentType: "application/json",
	    dataType:"json",
...
$('a[name=gradeSelect]').on('click',function(){
    ...
    window.location.href="../teacherNotice/toTeacherSelect?schoolCode="+schoolCode+"&stage="+stage+"&grade="+hideGrade +"&classNo="+hideClass;
});
