...
<body ontouchstart>
    ...
    <div class="weui-cells">
	  ...
	  <a class="weui-cell weui-cell_access" href="javascript:void(0)" id="toParentSelect">
		<div class="weui-cell__hd"><img src="data:image/png;base64," alt="" style="width:20px;margin-right:5px;display:block"></div>
		<div class="weui-cell__bd">
		  <p>发送给谁</p>
		</div>
		<div class="weui-cell__ft">公开</div>
	  </a>
	...
	$("#publish").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if("02" == data.code){
					window.location.href="../pageSkip/notice";
				}
			}
		});
	});
